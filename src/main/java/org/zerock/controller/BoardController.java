...
public class BoardController {
	 ...
	 * read(BoardVO board, Model model) throws Exception {
	 * System.out.println("This is /read"); int bno = board.getBno();
	 * System.out.println("read : " + bno); model.addAttribute(service.read(bno)); }
	 */
